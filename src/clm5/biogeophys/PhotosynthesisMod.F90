! These changes support creating canopy Solar Induced Fluorescence (SIF),
! based upon Li at al.,(2022) https://doi.org/10.1029/2021MS002747 and SourceMod changes:
! https://github.com/RongLi29/CLM5-SIF
  ...
  subroutine InitHistory(this, bounds)
    ...
    if (.not. use_fates) then
       ...
       !SIF
           ...
           call hist_addfld1d (fname='SIFESCN', units='W/m2/um',  &
                        avgflag='A', long_name='fluorescence escaping canopy', &
